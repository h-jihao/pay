...
public class PayConfig {
     ...
     */
    @Bean
    public BestPayService wxPayConfig(){
        //设置微信支付方式的请求参数
        WxPayConfig payConfig = new WxPayConfig();
        payConfig.setAppId("wxd898fcb01713c658");
        payConfig.setMchId("1483469312");
        payConfig.setMchKey("098F6BCD4621D373CADE4E832627B4F6");
        payConfig.setNotifyUrl("http://aji-pay.natapp1.cc/pay/notify");
        ...
        aliPayConfig.setNotifyUrl("http://aji-pay.natapp1.cc/pay/notify");
